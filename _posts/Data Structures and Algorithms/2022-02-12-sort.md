...
Bubble sort is a sorting algorithm that *<span style='font-size:1.1em; background-color: #FFF39B'>compares two adjacent elements and **swaps** them until the list is sorted.</span>* <br/>
...
### 2.3 Time complexity of Selection Sort
---
...
---
- *a small list is to be sorted*<br/>
...
---
- *the array is has a small number of elements*<br/>
- *there are only a few elements left to be sorted*<br/>
...
---
- *the programming language is good for recursion*<br/>
- *time complexity matters*<br/>
- *space complexity matters*<br/>
...
---
- *there are smaller integers with multiple counts.*<br/>
- *linear complexity is the need.*<br/>

## 6. Radix Sort

### 6.1 What is Radix Sort?
---
...
### 6.3 Time complexity of Radix Sort
---
...
---
- *DC3 algorithm (Kärkkäinen-Sanders-Burkhardt) while making a suffix array.*<br/>
- *places where there are numbers in large ranges.*<br/>
...
|Quick Sort|$$O(NlogN)$$|$$O(N)$$|In most cases, it is the most useful, and it is fast enough|
...
### 10.2 Solution : Swapping elements in two arrays
---
