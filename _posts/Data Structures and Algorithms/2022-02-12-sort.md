...
![Relationship between array and heap indices](/assets/img/data-structures-and-algorithms/sort/counting-sort_1.png)){:width="60%"} <br/> 
...
![Minheap](/assets/img/data-structures-and-algorithms/data-structures/heap_minheap.gif){:width="80%"}

<br>

**Max heap sort operation**

![Maxheap](/assets/img/data-structures-and-algorithms/data-structures/heap_maxheap.gif){:width="80%"}
<br>
